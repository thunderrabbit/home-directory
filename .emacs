...
(fset 'journal-dired-journal
   "\C-xd~/journal/2019\C-mg\C-[>p\C-mg~")


(fset 'journal-dired-blog
   [?\C-x ?d ?~ ?/ ?j ?o ?u ?r ?n ?a ?l ?- ?h ?u ?g ?o ?/ ?c ?o ?n ?t ?e ?n ?t ?/ ?b ?l ?o ?g ?/ ?2 ?* return escape ?> ?p return escape ?> ?p return ?g ?~])

(global-set-key (kbd "C-c c") 'journal-dired-journal)
(global-set-key (kbd "C-c C") 'journal-dired-blog)
